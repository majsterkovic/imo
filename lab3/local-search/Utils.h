...
public:
    ...
    static std::vector<std::vector<std::pair<int, int>>> compute_k_closest_neighbours(const std::vector<std::vector<int>> &dist_mat, int k);
    ...
    static std::pair<int, int> find_city(std::vector<int>& cycle1, std::vector<int>& cycle2, int node);
